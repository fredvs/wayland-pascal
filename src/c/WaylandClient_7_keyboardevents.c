...
// Compile with:
// cc -o keyboardevents WaylandClient_7_keyboardevents.c xdg-shell-protocol.c -lwayland-client -lxkbcommon -lrt
...
{ 
    fprintf(stderr, "Keyboard enter = OK, keys pressed = OK ");
    }
